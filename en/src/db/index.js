// SQLite connection and the poultry shop schema.
...
db.exec(`
  ...
  CREATE TABLE IF NOT EXISTS products (
    ...
    slug        TEXT NOT NULL,
    name        TEXT NOT NULL,
    unit        TEXT NOT NULL DEFAULT 'kg',           -- 'kg' | 'unit' | 'dozen'
    price       REAL NOT NULL DEFAULT 0,              -- price per unit
    description TEXT NOT NULL DEFAULT '',
    image       TEXT NOT NULL DEFAULT '',            -- product photo (data URL or URL)
  ...
  CREATE TABLE IF NOT EXISTS shop (
    ...
    whatsapp TEXT NOT NULL DEFAULT '',                -- digits only, international format (e.g. 5491122334455)
    hours    TEXT NOT NULL DEFAULT '',
    notes    TEXT NOT NULL DEFAULT ''
  );
`);

// --- Soft migrations for already-created databases (add new columns if missing) ---
